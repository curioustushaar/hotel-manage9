  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/staff/reservations" element={<ProtectedRoute module={MODULES.RESERVATIONS}><AdminDashboard /></ProtectedRoute>} />
        ...
        <Route path="/staff/room-service" element={<ProtectedRoute module={MODULES.RESERVATIONS}><AdminDashboard /></ProtectedRoute>} />
        ...
        <Route path="/staff/view-order" element={<ProtectedRoute module={MODULES.GUEST_MEAL_SERVICE}><AdminDashboard /></ProtectedRoute>} />
